                    ...
                    <Card className="space-y-10 shadow-[12px_12px_0px_0px_#111111]">
                        ...
                        <div className="pt-8 border-t border-[#111111]/5 space-y-6">
                            <Button
                                ...
                                disabled={!isValid}
                                className={`w-full py-5 text-xl font-serif italic font-bold gap-3 flex justify-center items-center ${!isValid ? 'opacity-50 cursor-not-allowed bg-gray-200 text-gray-400' : 'shadow-lg shadow-red-900/10'}`}
                            >
